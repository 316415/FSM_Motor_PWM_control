...
# set_property -dict { PACKAGE_PIN L1   IOSTANDARD LVCMOS33 } [get_ports { o_pwm }]; #IO_L6N_T0_VREF_35            ,Sch=LED15
...
set_property -dict { PACKAGE_PIN U2  IOSTANDARD LVCMOS33 } [get_ports { o_position  }]; #IO_L9N_T1_DQS_34   ,Sch=DP
# set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports { o_position[1]  }]; #IO_L11P_T1_SRCC_34 ,Sch=DP
# set_property -dict { PACKAGE_PIN V4  IOSTANDARD LVCMOS33 } [get_ports { o_position[2]  }]; #IO_L11N_T1_SRCC_34 ,Sch=DP
# set_property -dict { PACKAGE_PIN W4  IOSTANDARD LVCMOS33 } [get_ports { o_position[3]  }]; #IO_L12N_T1_MRCC_34 ,Sch=DP
...
set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { o_pwm }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
